...
# For backwards compatibility (if any code references this)
PGVECTOR_CONFIG = {
    'host': os.getenv('PGVECTOR_HOST', 'localhost'),
    'port': int(os.getenv('PGVECTOR_PORT', 5432)),
    'database': os.getenv('PGVECTOR_DB', 'mydb'),
    'user': os.getenv('PGVECTOR_USER', 'admin'),
    'password': os.getenv('PGVECTOR_PASSWORD', 'admin123'),
}
...
# =============================================================================
# PGVECTOR DATABASE (for Vanna's Training Data & Embeddings)
# =============================================================================
